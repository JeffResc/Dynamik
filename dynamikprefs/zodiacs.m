...
@interface DynamikTitleCell : PSTableCell <PreferencesTableCustomView> {
    UIView *bgView;
...
@implementation DynamikTitleCell
...
-(void)layoutSubviews{
    ...
    UIColor *topColor = UIColorFromRGB(0x262829);
    UIColor *bottomColor = UIColorFromRGB(0x212121);
